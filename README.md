...
```javascript
copy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-copy@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-copy@umd/bundle.js"></script>
```
